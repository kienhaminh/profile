      ...
      <div className="relative min-h-screen">
        ...
        <main className="pt-32 pb-20 px-6 max-w-5xl mx-auto">
          ...
          <section className="mb-32 relative">
            ...
            {/* Hero Avatar */}
            <div className="mb-8 hero-avatar">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-card/50 text-xs text-muted-foreground mb-8 hero-cta">
            ...
            <h1 className="text-5xl md:text-7xl font-medium text-foreground tracking-tight mb-6 leading-[1.1]">
              <span className="block hero-heading text-foreground">
                Crafting digital
              </span>
              <span className="block hero-heading mt-2 gradient-text-hero">
                experiences with code.
              </span>
            </h1>
            {/* Bio */}
            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed mb-10 font-light hero-bio">
              {INFORMATION.bio}
            </p>
